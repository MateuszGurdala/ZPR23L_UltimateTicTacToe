...
TEST_CASE("Verify if Game is against computer and computer starts, current symbol"
...
TEST_CASE("After move is made in game versus second human player"
  ...
  {
    bool isValidMove = gameHandler->PerformMoveValidation(outerBoardPoint,
                                       innerBoardPoint);
