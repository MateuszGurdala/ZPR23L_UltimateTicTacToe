...
TEST_CASE("PointToIndex converts point to index correctly") {
    ...
    Point point1(0, 0);
    int index1 = BoardIndexConverter::PointToIndex(point1, boardSize);
    REQUIRE(index1 == 0);

    Point point2(1, 2);
    int index2 = BoardIndexConverter::PointToIndex(point2, boardSize);
    REQUIRE(index2 == 5);

    Point point3(2, 1);
    int index3 = BoardIndexConverter::PointToIndex(point3, boardSize);
    REQUIRE(index3 == 7);
}
